 ...
 * @author vaish
 */
public class PhysicianSpecialty extends javax.swing.JPanel {

    /**
     * Creates new form PhysicianSpecialty
     */
    
            private JPanel maincard;
    private Login l;
    
    public PhysicianSpecialty(JPanel maicard, Login l) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PHYSICIAN SPECIALTY");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, 280, -1));

        jLabel12.setFont(new java.awt.Font("Sitka Text", 1, 14)); // NOI18N
        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel12.setText("PHYSICIAN ID");
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 130, 120, -1));
        ...
        add(txtphysician, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, 310, 30));

        jLabel13.setFont(new java.awt.Font("Sitka Text", 1, 14)); // NOI18N
        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel13.setText("SPECIALTY ID");
        add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 250, 110, -1));

        txtspecialty.setFont(new java.awt.Font("Sitka Text", 0, 18)); // NOI18N
        add(txtspecialty, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, 310, 30));
    ...
    private void btninsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btninsertActionPerformed
        ...
        try
        {
            ...
            if(txtphysician.getText().isEmpty() || txtspecialty.getText().isEmpty())
            {
                JOptionPane.showMessageDialog(this, "Empty fields encountered");
                return;
            }

            String sql = "INSERT INTO PhysicianSpecialty (PhysicianID,SpecialtyID) VALUES " +
            "('" + txtphysician.getText()+ "','" + txtspecialty.getText() + "')";
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        try
        {
            ...
            String sql = "UPDATE PhysicianSpecialty SET " +
            "PhysicianID = '" + txtphysician.getText() + "', " +
            "SpecialtyID = '" + txtspecialty.getText() + "', " +
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        try
        {
            ...
            String sql = "DELETE FROM PhysicianSpecialty WHERE PhysicianID = '" + selectedValue + "'";
    ...
    private void btnclearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnclearActionPerformed
        ...
        try
        {
            ...
            String sql = "select * from PhysicianSpecialty";
