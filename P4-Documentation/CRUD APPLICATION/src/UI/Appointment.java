...
public class Appointment extends javax.swing.JPanel {
    ...
    public Appointment(JPanel maicard, Login l) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 270, 180, 40));

        jLabel8.setFont(new java.awt.Font("Sitka Text", 1, 14)); // NOI18N
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("APOOINTMENT TYPE");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 360, 160, 40));
        ...
        add(txttype, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 400, 205, 30));

        txtstatus.setFont(new java.awt.Font("Sitka Text", 0, 18)); // NOI18N
        add(txtstatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 310, 205, 30));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "PATIENT ID", "PHYSICIAN ID", "STATUS", "TYPE"
            }
        ) {
        ...
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 100, 40));

        jLabel11.setFont(new java.awt.Font("Sitka Text", 1, 14)); // NOI18N
        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel11.setText("PHYSICIAN ID");
        add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, 120, 40));
        ...
        add(txtphysician, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 220, 205, 30));

        txtpatient.setFont(new java.awt.Font("Sitka Text", 0, 18)); // NOI18N
        add(txtpatient, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 130, 205, 30));
    ...
    private void btninsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btninsertActionPerformed
        ...
        try
        {
            ...
            if(txtpatient.getText().isEmpty() || txtphysician.getText().isEmpty() ||txtstatus.getText().isEmpty() || txttype.getText().isEmpty() )
            {
                JOptionPane.showMessageDialog(this, "Empty fields encountered");
                return;
            }
            
            String sql = "INSERT INTO Appointment (PatientID, PhysicianID, AppointmentStatus, AppointmentType) VALUES " +
            "('" + txtpatient.getText() + "','" + txtphysician.getText() + "','" +
            txtstatus.getText() + "','" + txttype.getText() + "')";
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        try
        {
            ...
            "AppointmentStatus = '" + txtstatus.getText() + "', " +
            "AppoinmentType = '" + txttype.getText() + "', " +
            "WHERE AppointmentID = " + selectedValue;
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        try
        {
            ...
            String sql = "DELETE FROM Appointment WHERE AppointmentID = '" + selectedValue + "'";
