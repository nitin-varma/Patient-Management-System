...
public class LabTest extends javax.swing.JPanel {
    ...
    public LabTest(JPanel maicard, Login l) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 90, 40));

        jLabel8.setFont(new java.awt.Font("Sitka Text", 1, 14)); // NOI18N
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("TEST DATE");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 100, 40));
        ...
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 330, 140, -1));

        txttype.setFont(new java.awt.Font("Sitka Text", 0, 18)); // NOI18N
        add(txttype, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 170, 205, 30));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "RECORD ID", "PHYSICIAN ID", "TEST TYPE", "TEST DATE", "TEST TIME", "DESCRIPTION"
            }
        ) {
        ...
        add(txttime, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 270, 205, 30));

        txtdescription.setFont(new java.awt.Font("Sitka Text", 0, 18)); // NOI18N
        add(txtdescription, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 320, 205, 30));
        add(jdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 220, 200, 31));
    ...
    private void btninsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btninsertActionPerformed
        ...
        try
        {
            ...
            if(txtrecord.getText().isEmpty() || txtphysician.getText().isEmpty() ||txttype.getText().isEmpty() || jdate.getDate()==null || txttime.getText().isEmpty() || txtdescription.getText().isEmpty())
            {
                JOptionPane.showMessageDialog(this, "Empty fields encountered");
                return;
            }
            String formattedDate2 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(jdate.getDate());

            String sql = "INSERT INTO LabTest (RecordID, PhysicianID, TestType, TestDate, TestTime,TestDescription) VALUES " +
            "('" + txtrecord.getText() + "','" + txtphysician.getText() + "','" +
            txttype.getText() + "','" + formattedDate2 + "','" + txttime.getText() +"','"+ txtdescription.getText() + "')";
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        try
        {
            ...
            String sql = "UPDATE LabTest SET " +
            "RecordID = '" + txtrecord.getText() + "', " +
            "PhysicianID = '" + txtphysician.getText() + "', " +
            "TestType = '" + txttype.getText() + "', " +
            "TestDate = '" + formattedDate2 + "', " +
            "TestTime = '" + txttime.getText() + "', " +
            "TestDescription = '" + txtdescription.getText() + "', " +
            "WHERE TestID = " + selectedValue;
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        try
        {
            ...
            String sql = "DELETE FROM LabTest WHERE TestID = '" + selectedValue + "'";
