...
public class Diagnosis extends javax.swing.JPanel {
    ...
    public Diagnosis(JPanel maicard, Login l) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, 170, -1));

        jLabel12.setFont(new java.awt.Font("Sitka Text", 1, 14)); // NOI18N
        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel12.setText("DIAGNOSIS NAME");
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 130, 150, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DIAGNOSIS ID", "DIAGNOSIS NAME", "DESCRIPTION"
            }
        ) {
        ...
        add(txtname, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, 310, 30));
        ...
        add(txtdescription, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, 310, 30));
    ...
    private void btninsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btninsertActionPerformed
        ...
        try
        {
            ...
            String sql = "INSERT INTO Diagnosis (DiagnosisName,Description) VALUES " +
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        try
        {
            ...
            "DiagnosisName = '" + txtname.getText()+ "', " +
            "Description = '" + txtdescription.getText() + "', " +
            "WHERE DiagnosisID = " + selectedValue;
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        try
        {
            ...
            String sql = "DELETE FROM Diagnosis WHERE DiagnosisID = '" + selectedValue + "'";
