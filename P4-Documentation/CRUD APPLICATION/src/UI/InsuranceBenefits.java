 ...
 * @author vaish
 */
public class InsuranceBenefits extends javax.swing.JPanel {

    /**
     * Creates new form InsuranceBenefits
     */
    
            private JPanel maincard;
    private Login l;
    public InsuranceBenefits(JPanel maicard, Login l) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INSURANCE BENEFITS");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 40, 300, -1));

        jLabel12.setFont(new java.awt.Font("Sitka Text", 1, 14)); // NOI18N
        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel12.setText("BENEFIT DESCRIPTION");
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 200, 180, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 50, 470, 500));
    ...
    private void btninsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btninsertActionPerformed
        ...
        try
        {
            ...
            String sql = "INSERT INTO InsuranceBenefits (BenefitDescription) VALUES " +
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        try
        {
            ...
            String sql = "UPDATE InsuranceBenefits SET " +
            "BenefitDescription = '" + txtdescription.getText() + "', " +
            "WHERE BenefitID = " + selectedValue;
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        try
        {
            ...
            String sql = "DELETE FROM InsuranceBenefits WHERE BenefitID = '" + selectedValue + "'";
    ...
    private void btnclearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnclearActionPerformed
        ...
        try
        {
            ...
            String sql = "select * from InsuranceBenefits";
